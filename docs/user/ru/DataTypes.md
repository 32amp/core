...
Формак коннектора у зарядной станции
...
---
Структура детализации бизнесса у конкретной зарядной станции
...
---
Структура используемая в структуре Hours, обознает исключение конкретного периода времени
...
#### struct RegularHours
---
Структура используемая в структуре Hours, обознает день недели и период работы
...
Тект отображения на разных языках
...
#### struct GeoLocation
---
Геоданные для логкации или зарядной станции
